<?php
	...
	echo '<div id="gallery-images" data-bind="foreach: visibleImages">
			<div class="gi">
				...
				<img data-bind="attr: {\'onerror\': function(){ console.log(\'err\'); }, src: \'/core/phpthumb/phpThumb.php?src=/core/uploads/\' + url + \'&w=211&f=png&sia=\' + title + \'&hash=\' + $root.loadTime, alt: title}"/>
			</div>
		</div>';
